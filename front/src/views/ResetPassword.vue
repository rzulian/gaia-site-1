  ...
  <div class="goldfish container">
    ...
    <form method="post" accept-charset="UTF-8" role="form" class="clearfix" @submit.prevent="submit">
      <div class="form-group">
        ...
        <input type="email" class="form-control" id="email" name="email" placeholder="Email address" :value="email" disabled required>
      </div>
      <div class="form-row">
        ...
        <div class="form-group col-md-6">
          ...
          <input type="password" class="form-control" id="signup-password-confirm" name="password-confirm" v-model="passwordConfirm" placeholder="Password" required>
        </div>
      </div>
